...
public class OnSecondSensorProgressListenerY implements SeekBar.OnSeekBarChangeListener {


    /**
     *             εναλλαγη του seek bar για  για τον αξονα y του accelerometer
     *
    ...
    public void onProgressChanged(SeekBar seekBar, int progress, boolean fromUser) {
        ...
        TextView textViewSecondSensorValue = (TextView) activity.findViewById(R.id.textViewSecondSensorValueY);
